<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400" style="margin-top: -10px!important;">
            {{ __('Usa una password lunga e generata in modo casuale per garantire la sicurezza.') }}
        </p>
    </header>
